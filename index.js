...
module.exports = function (homebridge) {
    ...
    homebridge.registerAccessory("homebridge-colortemp-http", "Http", HttpAccessoryColorTemp);
};


function HttpAccessoryColorTemp(log, config) {
    this.log = log;
...
HttpAccessoryColorTemp.prototype = {
